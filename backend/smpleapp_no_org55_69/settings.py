"""
Django settings for smpleapp_no_org55_69 project.
...
ROOT_URLCONF = 'smpleapp_no_org55_69.urls'
...
WSGI_APPLICATION = 'smpleapp_no_org55_69.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "SmpleApp - No Org55 Support <support@smpleapp-no-org55-69.botics.io>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "smpleapp_no_org55_69 API",
    "DESCRIPTION": "API documentation for smpleapp_no_org55_69 App",
    "VERSION": "v1",
}
